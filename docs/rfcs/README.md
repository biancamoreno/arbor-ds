...
| [RFC-0009](./RFC-0009-tamanhos-semanticos-em-icon.md) | Tamanhos semânticos para `Icon.size` | R3 | Draft |
| [RFC-0010](./RFC-0010-discriminated-union-decorative-em-icon.md) | Discriminated union `decorative` em `Icon` | R3 | Draft |
