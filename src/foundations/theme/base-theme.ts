  ...
  dialog: defineSlotRecipe({
    ...
    base: {
      overlay: {
        ...
        // engine de transformação — propriedades individuais são whitelistadas.
        position: 'fixed',
        top: 0,
        right: 0,
        bottom: 0,
        left: 0,
        backgroundColor: '$dialog.colors.overlay',
      },
      content: {
        position: 'fixed',
        top: '50%',
        ...
        borderStyle: 'solid',
        borderColor: '$dialog.colors.border',
      ...
      title: {
        ...
        fontFamily: 'sans',
        fontSize: '$dialog.title.typography.fontSize',
        fontWeight: '$dialog.title.typography.fontWeight',
        lineHeight: '$dialog.title.typography.lineHeight',
        letterSpacing: '$dialog.title.typography.letterSpacing',
        margin: 0,
      },
      description: {
        color: '$dialog.colors.description',
        fontFamily: 'sans',
        fontSize: '$dialog.description.typography.fontSize',
        fontWeight: '$dialog.description.typography.fontWeight',
        lineHeight: '$dialog.description.typography.lineHeight',
        letterSpacing: '$dialog.description.typography.letterSpacing',
        margin: 0,
      },
      close: {
        position: 'absolute',
        top: '$dialog.close.offset',
        right: '$dialog.close.offset',
        flexShrink: 0,
        display: 'inline-flex',
        alignItems: 'center',
        justifyContent: 'center',
        ...
        padding: 0,
        borderWidth: 0,
        borderRadius: '$dialog.close.borderRadius',
        backgroundColor: 'transparent',
        color: '$dialog.close.colors.icon',
        cursor: 'pointer',
        transition: transition(['background-color', 'color'], 'fast'),
        _hover: {
          backgroundColor: '$dialog.close.colors.backgroundHover',
          color: '$dialog.close.colors.iconHover',
        },
        _focusVisible: focusRing,
        _before: {
          content: '""',
          ...
          left: '50%',
          transform: 'translate(-50%, -50%)',
          minWidth: '$dialog.close.minTouch',
          minHeight: '$dialog.close.minTouch',
        },
      },
    },
    variants: {
  ...
  toast: defineSlotRecipe({
    ...
    base: {
      root: {
        ...
        alignItems: 'flex-start',
        gap: '$toast.gap',
        paddingLeft: '$toast.padding.inline',
        paddingRight: '$toast.padding.inline',
        paddingTop: '$toast.padding.block',
        paddingBottom: '$toast.padding.block',
        borderRadius: '$toast.borderRadius',
        borderLeftWidth: '$toast.borderLeftWidth',
        borderLeftStyle: 'solid',
        boxShadow: 'lg',
      },
      icon: { display: 'inline-flex', alignItems: 'center', flexShrink: 0 },
      title: {
        fontWeight: '$toast.fontWeight.title',
        fontSize: '$toast.fontSize.title',
        lineHeight: 'small',
        margin: 0,
      },
      description: {
        fontSize: '$toast.fontSize.description',
        lineHeight: 'small',
        margin: 0,
      },
      close: {
        ...
        _before: {
          ...
          left: '50%',
          transform: 'translate(-50%, -50%)',
          minWidth: '$toast.close.minTouch',
          minHeight: '$toast.close.minTouch',
        },
      },
    },
    variants: {
    ...
    compoundVariants: [
      { conditions: { tone: 'neutral'  }, style: { root: { backgroundColor: '$toast.colors.neutral.background',  borderLeftColor: '$toast.colors.neutral.borderColor'  }, icon: { color: '$toast.colors.neutral.icon'  }, title: { color: '$toast.colors.neutral.title'  }, description: { color: '$toast.colors.neutral.description'  }, close: { _hover: { backgroundColor: '$toast.colors.neutral.closeHover'  } } } },
      { conditions: { tone: 'brand'    }, style: { root: { backgroundColor: '$toast.colors.brand.background',    borderLeftColor: '$toast.colors.brand.borderColor'    }, icon: { color: '$toast.colors.brand.icon'    }, title: { color: '$toast.colors.brand.title'    }, description: { color: '$toast.colors.brand.description'    }, close: { _hover: { backgroundColor: '$toast.colors.brand.closeHover'    } } } },
      { conditions: { tone: 'info'     }, style: { root: { backgroundColor: '$toast.colors.info.background',     borderLeftColor: '$toast.colors.info.borderColor'     }, icon: { color: '$toast.colors.info.icon'     }, title: { color: '$toast.colors.info.title'     }, description: { color: '$toast.colors.info.description'     }, close: { _hover: { backgroundColor: '$toast.colors.info.closeHover'     } } } },
      { conditions: { tone: 'success'  }, style: { root: { backgroundColor: '$toast.colors.success.background',  borderLeftColor: '$toast.colors.success.borderColor'  }, icon: { color: '$toast.colors.success.icon'  }, title: { color: '$toast.colors.success.title'  }, description: { color: '$toast.colors.success.description'  }, close: { _hover: { backgroundColor: '$toast.colors.success.closeHover'  } } } },
      { conditions: { tone: 'warning'  }, style: { root: { backgroundColor: '$toast.colors.warning.background',  borderLeftColor: '$toast.colors.warning.borderColor'  }, icon: { color: '$toast.colors.warning.icon'  }, title: { color: '$toast.colors.warning.title'  }, description: { color: '$toast.colors.warning.description'  }, close: { _hover: { backgroundColor: '$toast.colors.warning.closeHover'  } } } },
      { conditions: { tone: 'critical' }, style: { root: { backgroundColor: '$toast.colors.critical.background', borderLeftColor: '$toast.colors.critical.borderColor' }, icon: { color: '$toast.colors.critical.icon' }, title: { color: '$toast.colors.critical.title' }, description: { color: '$toast.colors.critical.description' }, close: { _hover: { backgroundColor: '$toast.colors.critical.closeHover' } } } },
    ],
