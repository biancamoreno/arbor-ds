...
const components: ThemeComponents = {
  ...
  button: {
    ...
    variants: {
      variant: {
        primary: { backgroundColor: 'semantic.brand.solid', color: 'text.inverse' },
        secondary: {
          backgroundColor: 'transparent',
          borderWidth: 'hairline',
          borderColor: 'semantic.brand.solid',
        },
  ...
  input: defineSlotRecipe({
    ...
    variants: {
      ...
      state: {
        idle: {},
        error: { frame: { borderColor: 'feedback.critical.solid' } },
  ...
  checkbox: defineSlotRecipe({
    ...
    variants: {
      ...
      state: {
        ...
        invalid: { indicator: { borderColor: 'feedback.critical.solid' } },
  ...
  radio: defineSlotRecipe({
    ...
    variants: {
      ...
      state: {
        idle: {},
        checked: {
          control: { borderColor: 'brand.solid', backgroundColor: 'brand.bgElement' },
          indicator: { borderColor: 'brand.solid' },
        },
        invalid: { control: { borderColor: 'feedback.critical.solid' } },
        disabled: { root: { opacity: 0.6 } },
      },
    },
    defaultVariants: { size: 'medium', state: 'idle' },
  ...
  switch: defineSlotRecipe({
    ...
    variants: {
      ...
      state: {
        ...
        invalid: { track: { backgroundColor: 'feedback.critical.solid' } },
        disabled: { root: { opacity: 0.6 } },
      },
    },
    defaultVariants: { size: 'medium', state: 'idle' },
  ...
  select: defineSlotRecipe({
    ...
    variants: {
      ...
      state: {
        ...
        invalid: { trigger: { borderColor: 'feedback.critical.solid' } },
  ...
  tabs: defineSlotRecipe({
    ...
    compoundVariants: [
      { conditions: { variant: 'underline', state: 'active' },
        style: { trigger: { borderBottomColor: 'brand.solid', color: 'text.primary', fontWeight: 'medium' } } },
      { conditions: { variant: 'pill', state: 'active' },
        style: { trigger: { backgroundColor: 'brand.solid', color: 'text.inverse', fontWeight: 'medium' } } },
    ],
