...
const recipes: ThemeRecipes = {
  ...
  tag: defineSlotRecipe({
    ...
    compoundVariants: [
      ...
      { conditions: { tone: 'neutral',  selected: 'false' }, style: { root: { backgroundColor: 'background.subtle',        borderColor: 'border.subtle',            color: 'text.secondary'           } } },
      { conditions: { tone: 'brand',    selected: 'true' },  style: { root: { backgroundColor: 'brand.solid',              borderColor: 'brand.solid',              color: 'text.inverse'             } } },
      { conditions: { tone: 'brand',    selected: 'false' }, style: { root: { backgroundColor: 'brand.bgSubtle',           borderColor: 'brand.borderSubtle',       color: 'brand.text'               } } },
      ...
      { conditions: { tone: 'success',  selected: 'false' }, style: { root: { backgroundColor: 'feedback.success.bgSubtle',borderColor: 'feedback.success.borderSubtle', color: 'feedback.success.text'} } },
      ...
      { conditions: { tone: 'warning',  selected: 'false' }, style: { root: { backgroundColor: 'feedback.warning.bgSubtle',borderColor: 'feedback.warning.borderSubtle', color: 'feedback.warning.text'} } },
      ...
      { conditions: { tone: 'critical', selected: 'false' }, style: { root: { backgroundColor: 'feedback.critical.bgSubtle',borderColor: 'feedback.critical.borderSubtle', color: 'feedback.critical.text'} } },
      ...
      { conditions: { tone: 'info',     selected: 'false' }, style: { root: { backgroundColor: 'feedback.info.bgSubtle',   borderColor: 'feedback.info.borderSubtle',color: 'feedback.info.text'       } } },
    ],
