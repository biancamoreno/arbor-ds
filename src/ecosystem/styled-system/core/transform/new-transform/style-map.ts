...
styleMap.set('paddingInline', getMultiNumberProp('space', 'paddingLeft', 'paddingRight'));
styleMap.set('paddingInlineStart', getCustomProp('paddingLeft', 'space', getRawNumber));
styleMap.set('paddingInlineEnd', getCustomProp('paddingRight', 'space', getRawNumber));
styleMap.set('paddingBlock', getMultiNumberProp('space', 'paddingTop', 'paddingBottom'));
styleMap.set('paddingBlockStart', getCustomProp('paddingTop', 'space', getRawNumber));
styleMap.set('paddingBlockEnd', getCustomProp('paddingBottom', 'space', getRawNumber));
styleMap.set('marginX', getMultiNumberProp('space', 'marginLeft', 'marginRight'));
styleMap.set('marginInline', getMultiNumberProp('space', 'marginLeft', 'marginRight'));
styleMap.set('marginInlineStart', getCustomProp('marginLeft', 'space', getRawNumber));
styleMap.set('marginInlineEnd', getCustomProp('marginRight', 'space', getRawNumber));
styleMap.set('marginBlock', getMultiNumberProp('space', 'marginTop', 'marginBottom'));
styleMap.set('marginBlockStart', getCustomProp('marginTop', 'space', getRawNumber));
styleMap.set('marginBlockEnd', getCustomProp('marginBottom', 'space', getRawNumber));
