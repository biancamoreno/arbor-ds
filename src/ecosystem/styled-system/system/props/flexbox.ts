...
export interface FlexboxProps {
   ...
   */
  flexGrow?: ResponsiveValue<CSS.Property.FlexGrow | (string & number)>;
  /**
   ...
   */
  flexShrink?: ResponsiveValue<CSS.Property.FlexShrink | (string & number)>;
  /**
   ...
   *
   * @see [Mozilla Docs](https://developer.mozilla.org/en-US/docs/Web/CSS/gap)
   */
  gap?: ResponsiveValue<Token<Theme['space']> | number>;
}
