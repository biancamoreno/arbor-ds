...
describe('html-converter', () => {
  it('should pass parent style to children elements', () => {
    ...
    expect(result).toStrictEqual([
      { as: 'b', children: 'Hello', color: 'support.success.a', fontWeight: 'bold' },
      { as: 'i', children: 'World', color: 'support.success.a', fontStyle: 'italic' },
    ]);
  });
  ...
  it('should create underline props using tag "u"', () => {
    ...
    expect(result).toStrictEqual([
      { as: 'u', children: 'Hello', textDecorationLine: 'underline' },
    ]);
  });
  ...
  it('should create line-through props using tag "s"', () => {
    ...
    expect(result).toStrictEqual([
      { as: 's', children: 'Hello', textDecorationLine: 'line-through' },
    ]);
  });
  ...
  it('should create line-through props using tag "del"', () => {
    ...
    expect(result).toStrictEqual([
      { as: 'del', children: 'Hello', textDecorationLine: 'line-through' },
    ]);
  });

  it('should create italic props using tag "i"', () => {
    const result = htmlConverter('<i>Hello</i>');
    expect(result).toStrictEqual([{ as: 'i', children: 'Hello', fontStyle: 'italic' }]);
  });

  it('should create bold props using tag "b"', () => {
    const result = htmlConverter('<b>Hello</b>');
    expect(result).toStrictEqual([{ as: 'b', children: 'Hello', fontWeight: 'bold' }]);
  });
  ...
  it('should create text props using tag span', () => {
    ...
    expect(result).toStrictEqual([
      { as: 'span', children: 'Hello', color: 'support.success.a' },
    ]);
  });
